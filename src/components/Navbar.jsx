...
function Navbar() {
  ...
  return (
    <>
      {/* Fixed announcement bar and navbar */}
      ...
      <div className="fixed top-0 left-0 right-0 z-[9999]">
        ...
        <header
          className={`w-full transition-all duration-500 ease-out ${
            scrolled
              ? "bg-[#fffaf7]/75 backdrop-blur-2xl border-b border-[#eadbd4]/70 shadow-[0_12px_40px_rgba(91,59,50,0.14)]"
              : "bg-[#fffaf7]/92 backdrop-blur-xl border-b border-[#eadbd4]/40 shadow-sm"
          }`}
        >
          <Container>
            <div
            ...
            >
              ...
              <nav className="hidden lg:flex flex-1 items-center">
                <ul className="flex items-center gap-7 xl:gap-9 text-[11px] xl:text-xs tracking-[0.18em] font-semibold text-[#5B3B32] uppercase">
                  ...
                  >
                    ...
                    <div
                      className={`absolute left-0 top-full pt-6 transition-all duration-300 ${
                        showMegaMenu
              ...
              >
                <div
                  className={`logo-font text-[#9A3F4D] transition-all duration-500 ease-out ${
                    scrolled
                ...
                <div
                  className={`font-semibold text-[#BFA996] transition-all duration-500 ${
                    scrolled
                      ? "text-[8px] md:text-[9px] tracking-[0.36em]"
                      : "text-[9px] md:text-[11px] tracking-[0.44em]"
                  }`}
                >
                  FASHION
                </div>
              ...
              <div className="flex items-center justify-end gap-1 sm:gap-2 md:gap-3 text-[#5B3B32]">
                ...
                <button
                  ...
                  className="md:hidden w-10 h-10 rounded-full flex items-center justify-center hover:text-[#9A3F4D] hover:bg-white/70 transition-all duration-300"
                  aria-label="Search products"
                >
                  <FiSearch size={20} />
                </button>
                ...
                >
                  {!isLoggedIn ? (
                    <Link
                      to="/login"
                      className="w-10 h-10 rounded-full border border-[#eadbd4] bg-white/65 backdrop-blur-md flex items-center justify-center hover:text-[#9A3F4D] hover:border-[#9A3F4D] transition-all duration-300"
                    ...
                    <>
                      <button
                        ...
                        className="flex items-center gap-2 rounded-full hover:bg-white/60 p-1 xl:pr-3 transition-all duration-300"
      ...
      {/* Reserved space for fixed navbar */}
      ...
      <div
        className={`lg:hidden fixed left-0 right-0 bottom-0 z-[9998] transition-all duration-500 ease-out ${
          scrolled
            ? "top-[108px] md:top-[116px]"
            : "top-[122px] md:top-[140px]"
        } ${
          menuOpen
            ? "visible opacity-100 translate-y-0"
      ...
      >
        <button
          ...
          className="absolute inset-0 w-full h-full bg-[#3d2822]/25 backdrop-blur-sm"
          aria-label="Close mobile menu"
        />

        <div className="relative max-h-full overflow-y-auto border-t border-[#eadbd4] bg-[#fffaf7]/98 backdrop-blur-2xl shadow-2xl">
          <Container>
            <div className="py-6">
              {/* Mobile search */}
              ...
              <div className="mt-7 grid gap-1">
                ...
                <div>
                  <button
                    ...
                    className={`w-full flex items-center justify-between rounded-2xl px-4 py-3 text-sm font-semibold tracking-[0.12em] uppercase transition-colors ${
                      mobileCollectionOpen ||
                      isProductsActive
                        ? "bg-[#f6ebe7] text-[#9A3F4D]"
                        : "text-[#5B3B32] hover:bg-[#f6ebe7] hover:text-[#9A3F4D]"
                    }`}
                  >
                  ...
                  >
                    <div className="overflow-hidden">
                      ...
                      <Link
                        to="/products"
                        className="mx-2 mb-3 flex items-center justify-center rounded-full bg-[#9A3F4D] py-3 text-[10px] tracking-[0.16em] uppercase font-semibold text-white"
                      >
                        View All Collection
                      </Link>
                    </div>

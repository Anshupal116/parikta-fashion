...
function Customize() {
  return (
    <>
      ...
      <main className="min-h-screen bg-[#f7f2ee] flex items-center py-10">
        <Container>
          <div className="mx-auto max-w-3xl rounded-[32px] border border-[#eadbd4] bg-[#fffaf7] px-6 py-14 text-center shadow-sm sm:px-10">
            <div className="mx-auto flex h-20 w-20 items-center justify-center rounded-full bg-[#FDEAE6] text-[#9A3F4D]">
              <FiClock size={38} />
            </div>

            <p className="mt-8 text-xs font-semibold tracking-[0.3em] text-[#BFA996]">
              PARIKTA EXCLUSIVE
            </p>

            <h1 className="heading-font mt-3 text-4xl text-[#5B3B32] sm:text-6xl">
              Coming Soon
            </h1>

            <p className="mx-auto mt-5 max-w-xl text-sm leading-7 text-[#8b746b] sm:text-base">
              Our Custom Design Studio is currently under development.
              Soon you'll be able to design your dream outfit, choose fabrics,
              upload references and get it stitched exclusively for you.
            </p>

            <div className="mt-8 rounded-2xl border border-[#eadbd4] bg-[#FDEAE6] p-5 text-[#5B3B32]">
              ✨ This premium feature will be available in the next update.
            </div>

            <Link
              to="/products"
              className="mt-10 inline-flex min-h-12 items-center justify-center rounded-xl bg-[#9A3F4D] px-8 font-bold text-white transition hover:bg-[#7d3140]"
            >
              Explore Collection
            </Link>
          </div>
